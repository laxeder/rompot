...
class WhatsAppConvertMessage {
    ...
    convertMediaMessage(content, contentType) {
        ...
        if (contentType == "imageMessage") {
            msg = new ImageMessage_1.default(this._chat, this._convertedMessage.text, content.url);
        }
        if (contentType == "videoMessage") {
            msg = new VideoMessage_1.default(this._chat, this._convertedMessage.text, content.url);
        }
        if (contentType == "audioMessage") {
            msg = new AudioMessage_1.default(this._chat, content.url);
        }
