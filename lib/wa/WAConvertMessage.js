...
const User_1 = __importDefault(require("../modules/user/models/User"));
...
class WhatsAppConvertMessage {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((chat === null || chat === void 0 ? void 0 : chat.id.includes("@s")) || !chat.id.includes("@")) {
                ...
                if (!message.key.fromMe) {
                    ...
                    if (!!this.chat.name && ((_c = this.wa.chats[id]) === null || _c === void 0 ? void 0 : _c.name) != this.chat.name) {
                        if (this.wa.chats.hasOwnProperty(id)) {
                            yield this.wa.setChat(this.chat);
                        }
                        else {
    ...
    convertContentMessage(messageContent) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let contentType = (0, baileys_1.getContentType)(messageContent);
            if (!contentType) {
                this.convertedMessage = new index_1.EmptyMessage();
                return;
            }
            ...
            if (contentType == "protocolMessage") {
                yield this.convertProtocolMessage(messageContent[contentType]);
                return;
            }
            ...
            if (!this.convertedMessage.text) {
                this.convertedMessage.text = content.text || content.caption || content.buttonText || ((_a = content.hydratedTemplate) === null || _a === void 0 ? void 0 : _a.hydratedContentText) || content.displayName || content.contentText || "";
            }
    ...
    convertConversationMessage(content) {
        this.convertedMessage = new index_1.TextMessage(this.chat, content);
    }
    /**
    ...
    convertExtendedTextMessage(content) {
        this.convertedMessage = new index_1.TextMessage(this.chat, content.text);
    }
    /**
     * * Converte mensagem de protocolo
     * @param content
     */
    convertProtocolMessage(content) {
        return __awaiter(this, void 0, void 0, function* () {
            if (content.type == 0) {
                this.convertedMessage.isDeleted = true;
            }
            if (content.type == 14) {
                yield this.convertEditedMessage(content);
            }
            this.convertedMessage = new index_1.EmptyMessage();
        });
    }
    ...
    convertButtonMessage(content) {
        ...
        if (buttonMessage.buttons) {
            buttonMSG.type = rompot_base_1.MessageType.Button;
        ...
        if (buttonMessage.hydratedButtons) {
            buttonMSG.type = rompot_base_1.MessageType.TemplateButton;
