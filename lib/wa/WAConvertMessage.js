...
class WhatsAppConvertMessage {
    constructor(wa, message, type) {
        this._message = {};
        this._convertedMessage = new index_1.Message("", "");
    ...
    get() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._convertedMessage.chat = new Chat_1.default(this._chat.id, this._chat.type, this._chat.name);
            this._convertedMessage.user = new User_1.default(this._user.id, this._user.name);
    ...
    convertMessage(message, type) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!!!message) {
                this._convertedMessage = new index_1.EmptyMessage();
                return;
            }
            const id = (0, ID_1.replaceID)(((_a = message === null || message === void 0 ? void 0 : message.key) === null || _a === void 0 ? void 0 : _a.remoteJid) || "");
            const chat = this._wa.chats[id] ? this._wa.chats[id] : new WAModules_1.WAChat(id);
            if (id) {
                if (chat)
                    this._chat = chat;
                this._chat.id = id;
            ...
            if (chat === null || chat === void 0 ? void 0 : chat.id.includes("@g")) {
                ...
                this._chat.name = ((_b = this._wa.chats[chat.id]) === null || _b === void 0 ? void 0 : _b.name) || "";
            }
            if ((chat === null || chat === void 0 ? void 0 : chat.id.includes("@s")) || !chat.id.includes("@")) {
                ...
                if (!message.key.fromMe) {
                    ...
                    if (!this._wa.chats.hasOwnProperty(id) || (!!this._chat.name && this._wa.chats[id].name != this._chat.name)) {
                        yield this._wa.addChat(this._chat);
                    }
                }
            }
            ...
            const user = this._wa.users[userID] || new WAModules_1.WAUser(userID);
            if (!!message.pushName)
    ...
    convertContentMessage(messageContent) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!contentType || (contentType == "protocolMessage" && !!((_a = messageContent[contentType]) === null || _a === void 0 ? void 0 : _a.historySyncNotification))) {
                this._convertedMessage = new index_1.EmptyMessage();
                return;
            }
            ...
            if (!!!this._convertedMessage.text) {
                this._convertedMessage.text =
                    content.text || content.caption || content.buttonText || ((_b = content.hydratedTemplate) === null || _b === void 0 ? void 0 : _b.hydratedContentText) || content.displayName || content.contentText || this._convertedMessage.text || "";
            }
            ...
            if (contentType == "protocolMessage")
                this._convertedMessage.isDeleted = true;
        });
    }
    /**
    ...
    convertLocationMessage(content) {
        this._convertedMessage = new index_1.LocationMessage(this._chat, content.degreesLatitude, content.degreesLongitude);
    }
    /**
    ...
    convertContactMessage(content) {
        const msg = new index_1.ContactMessage(this._chat, content.displayName, []);
    ...
    convertMediaMessage(content, contentType) {
        return __awaiter(this, void 0, void 0, function* () {
            var msg = new index_1.MediaMessage(this._chat, "", Buffer.from(""));
            const file = { stream: this._message };
            if (contentType == "documentMessage") {
                msg = new index_1.FileMessage(this._chat, this._convertedMessage.text, file);
            }
            if (contentType == "imageMessage") {
                msg = new index_1.ImageMessage(this._chat, this._convertedMessage.text, file);
            }
            if (contentType == "videoMessage") {
                msg = new index_1.VideoMessage(this._chat, this._convertedMessage.text, file);
            }
            if (contentType == "audioMessage") {
                msg = new index_1.AudioMessage(this._chat, file);
            }
            if (contentType == "stickerMessage") {
                msg = new index_1.StickerMessage(this._chat, file);
                try {
                    yield (0, dist_1.extractMetadata)(yield this._wa.downloadStreamMessage(file))
                        .then((data) => {
                        if ((0, Message_2.isStickerMessage)(msg)) {
    ...
    convertReactionMessage(content) {
        this._convertedMessage = new index_1.ReactionMessage(this._chat, content.text, content.key.id);
    }
    /**
    ...
    convertPollCreationMessage(content) {
        ...
        const pollMessage = new index_1.PollMessage(this._chat, content.name);
    ...
    convertPollUpdateMessage(content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pollUpdate = new index_1.PollUpdateMessage(this._chat, (pollCreation === null || pollCreation === void 0 ? void 0 : pollCreation.text) || "");
            if (pollCreation) {
    ...
    convertButtonMessage(content) {
        ...
        const buttonMSG = new index_1.ButtonMessage(this._chat, "", "");
    ...
    convertListMessage(content) {
        ...
        if (!!!listMessage)
            return;
        const listMSG = new index_1.ListMessage(this._chat, "", "");
