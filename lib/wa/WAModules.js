...
const ChatUtils_1 = __importDefault(require("../modules/chat/utils/ChatUtils"));
...
class WAChat extends Chat_1.default {
     ...
     */
    static getChatType(chat) {
        return ChatUtils_1.default.get(chat).id.includes("@g") ? "group" : "pv";
    }
}
