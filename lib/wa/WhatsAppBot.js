...
class WhatsAppBot {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    this.sock = (0, baileys_1.default)(Object.assign({ auth: {
                            creds: state.creds,
                    ...
                    this.sock.ev.on("connection.update", (update) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (update.connection == "connecting") {
                            this.ev.emit("connecting", { action: "connecting" });
                        }
                        if (update.qr) {
                    ...
                    this.sock.ws.on("CB:notification,,remove", (data) => __awaiter(this, void 0, void 0, function* () {
                        var _g;
                        for (const content of ((_g = data.content[0]) === null || _g === void 0 ? void 0 : _g.content) || []) {
                            yield this.groupParticipantsUpdate(content.attrs.jid == data.attrs.participant ? "leave" : "remove", data.attrs.from, content.attrs.jid, data.attrs.participant);
                        }
                    }));
                    this.sock.ws.on("CB:notification,,add", (data) => __awaiter(this, void 0, void 0, function* () {
                        var _h;
                        for (const content of ((_h = data.content[0]) === null || _h === void 0 ? void 0 : _h.content) || []) {
                            yield this.groupParticipantsUpdate(content.attrs.jid == data.attrs.participant ? "join" : "add", data.attrs.from, content.attrs.jid, data.attrs.participant);
                        }
                    }));
                    this.sock.ws.on("CB:notification,,promote", (data) => __awaiter(this, void 0, void 0, function* () {
                        var _j;
                        for (const content of ((_j = data.content[0]) === null || _j === void 0 ? void 0 : _j.content) || []) {
                            yield this.groupParticipantsUpdate("promote", data.attrs.from, content.attrs.jid, data.attrs.participant);
                        }
                    }));
                    this.sock.ws.on("CB:notification,,demote", (data) => __awaiter(this, void 0, void 0, function* () {
                        var _k;
                        for (const content of ((_k = data.content[0]) === null || _k === void 0 ? void 0 : _k.content) || []) {
                            yield this.groupParticipantsUpdate("demote", data.attrs.from, content.attrs.jid, data.attrs.participant);
                        }
                    }));
    ...
    readChats() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const id of Object.keys(chats || {})) {
                ...
                if (!!!chat)
                    return;
                this.chats[id] = new Chat_1.default(chat.id, chat.type, chat.name, chat.description, chat.profile);
                for (const userId of Object.keys(chat.users || {})) {
                    const user = chat.users[userId];
                    if (!!!user)
                        continue;
                    this.chats[id].users[userId] = new User_1.default(user.id, user.name, user.description, user.profile);
    ...
    readUsers() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const id of Object.keys(users || {})) {
                ...
                if (!!!user)
                    continue;
                this.users[id] = new User_1.default(user.id, user.name, user.description, user.profile);
            }
        });
    }
    /**
    ...
    groupParticipantsUpdate(action, chatId, userId, fromId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fromUser = (event == "remove" && (0, ID_1.replaceID)(userId) == this.id ? yield this.getUser(new User_1.default((0, ID_1.replaceID)(fromId))) : (_a = this.chats[(0, ID_1.replaceID)(chatId)]) === null || _a === void 0 ? void 0 : _a.users[(0, ID_1.replaceID)(fromId)]) ||
                new User_1.default((0, ID_1.replaceID)(fromId));
            const user = (event == "remove" && (0, ID_1.replaceID)(userId) == this.id ? yield this.getUser(new User_1.default((0, ID_1.replaceID)(userId))) : (_b = this.chats[(0, ID_1.replaceID)(chatId)]) === null || _b === void 0 ? void 0 : _b.users[(0, ID_1.replaceID)(userId)]) ||
                new User_1.default((0, ID_1.replaceID)(userId));
            const chat = (event == "remove" && (0, ID_1.replaceID)(userId) == this.id ? yield this.getChat(new Chat_1.default((0, ID_1.replaceID)(chatId))) : this.chats[(0, ID_1.replaceID)(chatId)]) ||
                new Chat_1.default((0, ID_1.replaceID)(chatId), chatId.includes("@g") ? "group" : "pv");
    ...
    readMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = {
                ...
                participant: message.chat.id.includes("@g") ? (0, ID_1.getID)(message.user.id || this.id) : (0, ID_1.getID)(this.id),
                toJSON: () => message,
            };
    ...
    addReaction(message, reaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.wcb.waitCall(() => { var _a; return (_a = this.sock) === null || _a === void 0 ? void 0 : _a.sendMessage((0, ID_1.getID)(message.chat.id), waMSG.message); });
        });
    }
    ...
    send(content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (waMSG.isRelay) {
                yield this.wcb.waitCall(() => { var _a; return (_a = this.sock) === null || _a === void 0 ? void 0 : _a.relayMessage(waMSG.chat, waMSG.message, Object.assign(Object.assign({}, waMSG.options), { messageId: waMSG.chat })); }).catch((err) => this.ev.emit("error", err));
                return content;
            }
            ...
            if (msgRes instanceof PollMessage_1.default && content instanceof PollMessage_1.default) {
