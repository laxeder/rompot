...
class WhatsAppBot extends BaseBot_1.BaseBot {
    constructor(config = {}) {
        ...
        this.config = Object.assign({ printQRInTerminal: true, logger: (0, logger_1.loggerConfig)({ level: "silent" }), patchMessageBeforeSending: (message) => {
            ...
            return yield new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    this._bot.ev.on("chats.update", (updates) => {
                        var _a;
                        for (const update of updates)
                            if ((_a = update.id) === null || _a === void 0 ? void 0 : _a.includes("@g"))
                                this.chatUpsert(update);
                    });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.chats[id]) {
                ...
                if (id.includes("@g")) {
                    ...
                    if (metadata)
                        yield this.chatUpsert(new Chat_1.Chat(metadata.id, metadata.subject));
                }
            }
    ...
    send(content) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (content instanceof Message_1.Message) {
                ...
                // }
                return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.sendMessage(chat, message, context);
            }
            if (content instanceof Status_1.Status) {
                if (content.status === "reading") {
                    return (_b = this._bot) === null || _b === void 0 ? void 0 : _b.readMessages([
                        { remoteJid: (_c = content.chat) === null || _c === void 0 ? void 0 : _c.id, id: (_d = content.message) === null || _d === void 0 ? void 0 : _d.id, participant: (_e = content.message) === null || _e === void 0 ? void 0 : _e.user.id },
                    ]);
                }
                const status = this.statusOpts[content.status];
                return (_f = this._bot) === null || _f === void 0 ? void 0 : _f.sendPresenceUpdate(status, (_g = content.chat) === null || _g === void 0 ? void 0 : _g.id);
            }
        });
    }
    /**
