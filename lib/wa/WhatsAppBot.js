...
class WhatsAppBot {
    ...
    connect(auth) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.sock.waitForSocketOpen();
    ...
    addReaction(message, reaction) {
        return __awaiter(this, void 0, void 0, function* () {
            const reactionMessage = new ReactionMessage_1.default(message.chat, reaction, message, { user: message.user });
            yield this.send(reactionMessage);
        });
    }
    removeReaction(message) {
        return __awaiter(this, void 0, void 0, function* () {
            const reactionMessage = new ReactionMessage_1.default(message.chat, "", message, { user: message.user });
            yield this.send(reactionMessage);
        });
    }
    send(content) {
