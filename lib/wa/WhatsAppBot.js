...
const WAMessage_1 = require("@wa/WAMessage");
const WAUser_1 = __importDefault(require("@wa/WAUser"));
const WAChat_1 = __importDefault(require("@wa/WAChat"));
const ID_1 = require("@wa/ID");
const WAStatus_1 = require("@wa/WAStatus");
...
class WhatsAppBot {
    constructor() {
        ...
        this.status = "offline";
        this.id = "";
        this.auth = new Auth_1.MultiFileAuthState("./session");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    this._bot = (0, baileys_1.default)({ auth: state });
                        ...
                        if (update.connection == "open") {
                            ...
                            if (!!chats) {
                                Object.keys(chats).forEach((key) => {
                                    ...
                                    if (!!!chat)
                                        return;
                                    this.chats[key] = new WAChat_1.default((0, ID_1.replaceID)(chat.id), chat.type, chat.name, chat.description, chat.profile);
                                    if (chat === null || chat === void 0 ? void 0 : chat.users) {
                                        Object.keys((chat === null || chat === void 0 ? void 0 : chat.users) || {}).forEach((userKey) => {
                                            ...
                                            if (!!!user)
                                                return;
                                            this.chats[key].users[userKey] = new WAUser_1.default((0, ID_1.replaceID)(user.id), user.name, user.description);
                    ...
                    this._bot.ev.on("chats.upsert", (updates) => {
                        for (const update of updates) {
                            ...
                            if (!this.chats[update.id])
                                ...
                                this.chats[update.id].users[this.id] = new WAUser_1.default(this.id);
                            }
                        }
                    });
                    ...
                    this._bot.ev.on("chats.delete", (deletions) => {
                        for (const id of deletions)
                            this.removeChat(new WAChat_1.default(id));
                    });
                    ...
                    this._bot.ev.on("group-participants.update", ({ id, participants, action }) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        for (let p of participants) {
                            ...
                            const user = new WAUser_1.default(p);
                            if (action == "add")
                            ...
                            const chat = new WAChat_1.default(id);
                            if (this.chats[id]) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (chat.id || chat.newJId) {
                    ...
                    const newChat = new WAChat_1.default(chat.id, chat.name || chat.verifiedName || chat.notify || chat.subject);
                    if (newChat.id.includes("@g")) {
                        if (!chat.participants) {
                            const metadata = yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.groupMetadata((0, ID_1.getID)(newChat.id)); });
                        ...
                        for (const user of chat.participants) {
                            const u = new WAUser_1.default((0, ID_1.replaceID)(user.id));
            ...
            try {
                if (!this.chats[(0, ID_1.replaceID)(chat.id)]) {
                    if (chat.id.includes("@s") || !chat.id.includes("@")) {
                        yield this.chatUpsert(new WAChat_1.default(chat.id));
                    }
                    if (chat.id.includes("@g")) {
                        const metadata = yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.groupMetadata((0, ID_1.getID)(chat.id)); });
                        if (metadata)
    ...
    setChat(chat) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!chat.id.includes("@"))
                chat.type = "pv";
            this.chats[chat.id] = new WAChat_1.default(chat.id, chat.type, chat.name, chat.description);
    ...
    addUserInChat(chat, user) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!bot || !bot.isAdmin)
                return;
            yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.groupParticipantsUpdate((0, ID_1.getID)(chat.id), [(0, ID_1.getID)(user.id)], "add"); });
        });
    }
    removeUserInChat(chat, user) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!chat.id.includes("@g"))
                return;
            if (!(yield chat.IsAdmin(this.id)))
                return;
            yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.groupParticipantsUpdate((0, ID_1.getID)(chat.id), [(0, ID_1.getID)(user.id)], "remove"); });
        });
    }
    promoteUserInChat(chat, user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(yield chat.IsAdmin(this.id)))
                return;
            yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.groupParticipantsUpdate((0, ID_1.getID)(chat.id), [(0, ID_1.getID)(user.id)], "promote"); });
        });
    }
    demoteUserInChat(chat, user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(yield chat.IsAdmin(this.id)))
                return;
            yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.groupParticipantsUpdate((0, ID_1.getID)(chat.id), [(0, ID_1.getID)(user.id)], "demote"); });
        });
    }
    changeChatStatus(chat, status) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.wcb.waitCall(() => this._bot.sendPresenceUpdate(WAStatus_1.WAStatus[status] || "available", (0, ID_1.getID)(Chat_1.default.getChatId(chat))));
        });
    }
    createChat(chat) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.wcb.waitCall(() => this._bot.groupCreate(chat.name || "", [(0, ID_1.getID)(this.id)]));
        });
    }
    leaveChat(chat) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.chats.hasOwnProperty((0, ID_1.replaceID)(chat.id))) {
                ...
                if (!(yield chat.IsAdmin(this.id)))
                    return;
                return this.wcb.waitCall(() => this._bot.groupLeave((0, ID_1.getID)(chat.id)));
            }
    ...
    getUser(user) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.chats.hasOwnProperty(user.id)) {
                ...
                return new WAUser_1.default(chat.id, chat.name, chat.description);
            }
            return new WAUser_1.default(user.id);
        });
    }
    setUser(user) {
        return __awaiter(this, void 0, void 0, function* () {
            this.chats[user.id] = new WAChat_1.default(user.id, "pv", user.name, user.description, user.profile);
        });
    }
    getUsers() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const id in this.chats) {
                ...
                if (chat.type != "pv" || chat.id.includes("@"))
                    continue;
                users[id] = new WAUser_1.default(chat.id, chat.name, chat.description, chat.profile);
            }
            return users;
        });
    }
    ...
    blockUser(user) {
        return __awaiter(this, void 0, void 0, function* () {
            if (user.id == this.id)
                return;
            yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.updateBlockStatus((0, ID_1.getID)(user.id), "block"); });
        });
    }
    unblockUser(user) {
        return __awaiter(this, void 0, void 0, function* () {
            if (user.id == this.id)
                return;
            yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.updateBlockStatus((0, ID_1.getID)(user.id), "unblock"); });
        });
    }
    //! ******************************** NOME ********************************
    getBotName() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            return ((_a = (yield this.getChat(new WAChat_1.default(this.id)))) === null || _a === void 0 ? void 0 : _a.name) || "";
        });
    }
    setBotName(name) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getUserName(user) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            return ((_a = (yield this.getChat(new WAChat_1.default(user.id)))) === null || _a === void 0 ? void 0 : _a.name) || "";
        });
    }
    ...
    setChatName(chat, name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(yield chat.IsAdmin(this.id)))
                return;
            return this.wcb.waitCall(() => this._bot.groupUpdateSubject((0, ID_1.getID)(chat.id), name));
        });
    }
    //! ******************************* PROFILE *******************************
    getBotProfile() {
        return __awaiter(this, void 0, void 0, function* () {
            const uri = yield this.wcb.waitCall(() => this._bot.profilePictureUrl((0, ID_1.getID)(this.id), "image"));
            return yield (0, getImageURL_1.default)(uri);
        });
    }
    setBotProfile(image) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.wcb.waitCall(() => this._bot.updateProfilePicture((0, ID_1.getID)(this.id), image));
        });
    }
    getUserProfile(user) {
        return __awaiter(this, void 0, void 0, function* () {
            const uri = yield this.wcb.waitCall(() => this._bot.profilePictureUrl((0, ID_1.getID)(user.id), "image"));
            return yield (0, getImageURL_1.default)(uri);
        });
    }
    ...
    getChatProfile(chat) {
        return __awaiter(this, void 0, void 0, function* () {
            const uri = yield this.wcb.waitCall(() => this._bot.profilePictureUrl((0, ID_1.getID)(chat.id), "image"));
            return yield (0, getImageURL_1.default)(uri);
        });
    }
    setChatProfile(chat, image) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(yield chat.IsAdmin(this.id)))
                return;
            return this.wcb.waitCall(() => this._bot.updateProfilePicture((0, ID_1.getID)(chat.id), image));
        });
    }
    //! ****************************** DESCRIÇÃO ******************************
    getBotDescription() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.wcb.waitCall(() => __awaiter(this, void 0, void 0, function* () { var _a; return ((_a = (yield this._bot.fetchStatus(String((0, ID_1.getID)(this.id))))) === null || _a === void 0 ? void 0 : _a.status) || ""; }));
        });
    }
    ...
    getUserDescription(user) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.wcb.waitCall(() => __awaiter(this, void 0, void 0, function* () { var _a; return ((_a = (yield this._bot.fetchStatus(String((0, ID_1.getID)(user.id))))) === null || _a === void 0 ? void 0 : _a.status) || ""; }));
        });
    }
    ...
    setChatDescription(chat, description) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(yield chat.IsAdmin(this.id)))
                return;
            return this.wcb.waitCall(() => this._bot.groupUpdateDescription((0, ID_1.getID)(chat.id), description));
        });
    }
    //! ******************************* MESSAGE *******************************
    readMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = { remoteJid: (0, ID_1.getID)(message.chat.id), id: message.id || "", fromMe: message.user.id == this.id };
            if (message.chat.id.includes("@g")) {
                key.participant = (0, ID_1.getID)(message.user.id);
            }
            return yield this.wcb.waitCall(() => this._bot.readMessages([key]));
        });
    }
    ...
    deleteMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (message.chat.id.includes("@g")) {
                if (message.user.id != this.id && !(yield message.chat.IsAdmin(this.id)))
                    return;
                key.participant = (0, ID_1.getID)(message.user.id);
            }
            yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.sendMessage((0, ID_1.getID)(message.chat.id), { delete: key }); });
        });
    }
    addReaction(message, reaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.sendMessage((0, ID_1.getID)(message.chat.id), { react: { key: waMSG.message.key, text: reaction } }); });
        });
    }
    removeReaction(message) {
        return __awaiter(this, void 0, void 0, function* () {
            const waMSG = new WAMessage_1.WhatsAppMessage(this, message);
            yield waMSG.refactory(message);
            yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.sendMessage((0, ID_1.getID)(message.chat.id), { react: { key: waMSG.message.key, text: "" } }); });
        });
    }
    send(content) {
        return __awaiter(this, void 0, void 0, function* () {
            if (content instanceof MediaMessage_1.default) {
                yield this.changeChatStatus(content.chat, "recording");
            }
            else {
                yield this.changeChatStatus(content.chat, "typing");
            }
            ...
            if (message.hasOwnProperty("templateButtons")) {
                const ctx = {};
                const fullMsg = yield this.wcb.waitCall(() => (0, baileys_1.generateWAMessage)(chat, message, Object.assign({ userJid: (0, ID_1.getID)(this.id) }, ctx)));
                fullMsg.message = { viewOnceMessage: { message: fullMsg.message } };
                yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.relayMessage(chat, fullMsg.message, { messageId: fullMsg.key.id }); });
                sendedMessage = fullMsg;
            }
            else {
                sendedMessage = yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.sendMessage(chat, message, options); });
            }
    ...
    onExists(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.wcb.waitCall(() => { var _a; return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.onWhatsApp((0, ID_1.getID)(id)); });
    ...
    Chat(chat) {
        ...
        return new WAChat_1.default(chat.id, chat.type, chat.name, chat.description, chat.profile, users);
    }
    User(user) {
        if (this.chats.hasOwnProperty(user.id)) {
            const chat = this.chats[user.id];
            return new WAUser_1.default(user.id, chat.name, chat.description, chat.profile);
        }
        return new WAUser_1.default(user.id, user.name, user.description, user.profile);
    }
    Command() {
        return new Command_1.default();
    }
    Message(chat, text) {
        return new Message_1.default(this.Chat(chat), text);
    }
    MediaMessage(chat, text, file) {
        return new MediaMessage_1.default(this.Chat(chat), text, file);
    }
    ImageMessage(chat, text, image) {
        return new ImageMessage_1.default(this.Chat(chat), text, image);
    }
    VideoMessage(chat, text, video) {
        return new VideoMessage_1.default(this.Chat(chat), text, video);
    }
    AudioMessage(chat, audio) {
        return new AudioMessage_1.default(this.Chat(chat), audio);
    }
    ContactMessage(chat, text, contact) {
        return new ContactMessage_1.default(this.Chat(chat), text, contact);
    }
    LocationMessage(chat, latitude, longitude) {
        return new LocationMessage_1.default(this.Chat(chat), latitude, longitude);
    }
    ListMessage(chat, text, button) {
        return new ListMessage_1.default(this.Chat(chat), text, button);
    }
    ButtonMessage(chat, text) {
        return new ButtonMessage_1.default(this.Chat(chat), text);
    }
}
