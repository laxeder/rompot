...
class WhatsAppBot extends Bot_1.Bot {
                ...
                try {
                    ...
                    this._bot.ev.on("connection.update", (update) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (update.connection == "open") {
                            ...
                            const chats = JSON.parse((yield this.config.auth.get(`chats`)) || "{}");
                            if (!!chats) {
    ...
    saveChats(chats = this.chats) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.config.auth.set(`chats`, JSON.stringify(chats));
        });
    }
    /**
    ...
    sendMessage(content) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.config.disableAutoTyping)
                yield this.sendStatus(new Status_1.Status("typing", content.chat, content));
