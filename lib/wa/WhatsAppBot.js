...
class WhatsAppBot {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    this.sock = (0, baileys_1.default)({ auth: state });
    ...
    setChat(chat) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!chat.id.includes("@"))
                chat.type = "pv";
            this.chats[chat.id] = new Chat_1.default(chat.id, chat.type, chat.name, chat.description);
    ...
    changeChatStatus(chat, status) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.wcb.waitCall(() => this.sock.sendPresenceUpdate(WAStatus_1.WAStatus[status] || "available", (0, ID_1.getID)((0, Generic_1.getChatId)(chat))));
        });
    }
    createChat(chat) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getUser(user) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.chats.hasOwnProperty(user.id)) {
                ...
                return new User_1.default(chat.id, chat.name, chat.description);
            }
            return null;
        });
    }
    setUser(user) {
        return __awaiter(this, void 0, void 0, function* () {
            this.chats[user.id] = new Chat_1.default(user.id, "pv", user.name, user.description, user.profile);
        });
    }
    getUsers() {
        return __awaiter(this, void 0, void 0, function* () {
