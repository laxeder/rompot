...
class WhatsAppBot {
    ...
    getBotName() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getUserName(user_1.UserUtils.get(this.id));
        });
    }
    setBotName(name) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getBotDescription() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getUserDescription(user_1.UserUtils.get(this.id));
        });
    }
    ...
    getBotProfile() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getUserProfile(user_1.UserUtils.get(this.id));
        });
    }
    setBotProfile(image) {
        return __awaiter(this, void 0, void 0, function* () {
