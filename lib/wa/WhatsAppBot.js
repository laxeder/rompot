...
class WhatsAppBot {
    ...
    readChat(chat, save) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newChat = this.chats[chat.id] || new Chat_1.default(chat.id, chat.name || chat.verifiedName || chat.notify || chat.subject);
            if (newChat.id.includes("@g")) {
                if (!!!(chat === null || chat === void 0 ? void 0 : chat.participants)) {
                    ...
                    yield Promise.all(((chat === null || chat === void 0 ? void 0 : chat.participants) || []).map((p) => __awaiter(this, void 0, void 0, function* () {
                        const user = (yield this.getUser(User_1.default.get((0, ID_1.replaceID)(p.id)), false)) || new User_1.default((0, ID_1.replaceID)(p.id));
                ...
                if (save)
                    chat.description = yield this.getUserDescription(User_1.default.get(newChat.id));
            }
            ...
            const profile = yield this.getChatProfile(newChat);
            if (!!profile)
    ...
    readUser(user, save) {
        return __awaiter(this, void 0, void 0, function* () {
            const newUser = new User_1.default((0, ID_1.replaceID)(User_1.default.get((user === null || user === void 0 ? void 0 : user.id) || (user === null || user === void 0 ? void 0 : user.newJID) || user).id));
            newUser.name = (user === null || user === void 0 ? void 0 : user.name) || (user === null || user === void 0 ? void 0 : user.verifiedName) || (user === null || user === void 0 ? void 0 : user.notify) || (user === null || user === void 0 ? void 0 : user.subject) || (yield this.getUserName(newUser)) || "";
            newUser.description = (user === null || user === void 0 ? void 0 : user.desc) || (user === null || user === void 0 ? void 0 : user.description) || (yield this.getUserDescription(newUser)) || "";
            if (!!save)
    ...
    groupParticipantsUpdate(action, chatId, userId, fromId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (event == "remove" && (0, ID_1.replaceID)(userId) == this.id) {
                ...
                var fromUser = yield this.getUser(new User_1.default((0, ID_1.replaceID)(fromId)));
                var user = yield this.getUser(new User_1.default((0, ID_1.replaceID)(userId)));
                var chat = yield this.getChat(new Chat_1.default((0, ID_1.replaceID)(chatId)));
            }
            else {
                //? Obtem dados já existentes
                var fromUser = ((_a = this.chats[(0, ID_1.replaceID)(chatId)]) === null || _a === void 0 ? void 0 : _a.users[(0, ID_1.replaceID)(fromId)]) || new User_1.default((0, ID_1.replaceID)(fromId));
                var user = ((_b = this.chats[(0, ID_1.replaceID)(chatId)]) === null || _b === void 0 ? void 0 : _b.users[(0, ID_1.replaceID)(userId)]) || new User_1.default((0, ID_1.replaceID)(userId));
                var chat = this.chats[(0, ID_1.replaceID)(chatId)] || new Chat_1.default((0, ID_1.replaceID)(chatId), chatId.includes("@g") ? "group" : "pv");
            }
    ...
    getChat(chat, save) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.chats[(0, ID_1.replaceID)(chat.id)]) {
                const newChat = yield this.readChat(chat, save);
                return newChat;
            }
    ...
    getUser(user, save) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!usr) {
                if (!!save)
                    return yield this.readUser(user, save);
                usr = user;
            }
    ...
    getUserName(user) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            return ((_a = (yield this.getChat(new Chat_1.default(user.id), false))) === null || _a === void 0 ? void 0 : _a.name) || "";
        });
    }
    ...
    addSendedMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(message instanceof Message_1.default)) {
                message = this.wcb.waitCall(() => new WAConvertMessage_1.WhatsAppConvertMessage(this, message).get());
            }
    ...
    deleteMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.addSendedMessage(msg);
        });
    }
