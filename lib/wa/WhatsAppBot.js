...
class WhatsAppBot {
    constructor(config) {
        ...
        this.polls = {};
        this.sendedMessages = {};
        this.config = Object.assign({ printQRInTerminal: true, connectTimeoutMs: 2000, defaultQueryTimeoutMs: 30000, logger: this.logger, browser: WhatsAppBot.Browser() }, config);
    }
    connect(auth) {
    ...
    addSendedMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(message instanceof Message_1.default)) {
                message = yield this.wcb.waitCall(() => new WAConvertMessage_1.WhatsAppConvertMessage(this, message).get());
            }
     ...
     */
    static Browser(name = "Rompot", browser = "Chrome", version = "1.4.5") {
