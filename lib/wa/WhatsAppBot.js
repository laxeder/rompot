        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (content instanceof Status_1.Status) {
                if (content.status === "reading") {
                    const key = { remoteJid: (_b = content.chat) === null || _b === void 0 ? void 0 : _b.id, id: (_c = content.message) === null || _c === void 0 ? void 0 : _c.id };
                    if ((_d = key.remoteJid) === null || _d === void 0 ? void 0 : _d.includes("@g"))
                        key.participant = (_e = content.message) === null || _e === void 0 ? void 0 : _e.user.id;
                    return (_f = this._bot) === null || _f === void 0 ? void 0 : _f.readMessages([key]);
                }
                const status = this.statusOpts[content.status];
                return (_g = this._bot) === null || _g === void 0 ? void 0 : _g.sendPresenceUpdate(status, (_h = content.chat) === null || _h === void 0 ? void 0 : _h.id);
            }
        });
    }
    /**
