...
const BotEvents_1 = __importDefault(require("../modules/bot/events/BotEvents"));
...
class WhatsAppBot {
    constructor(config) {
        ...
        this.id = "";
        this.status = "offline";
        this.ev = new BotEvents_1.default();
        ...
        this.chatWCB = new WaitCallBack_1.default((err) => { });
        this.msgWCB = new WaitCallBack_1.default((err) => this.ev.emit("error", err));
        this.chats = {};
        this.users = {};
        this.polls = {};
        this.config = Object.assign({ printQRInTerminal: true, logger: this.logger, defaultQueryTimeoutMs: 10000, browser: WhatsAppBot.Browser(), getMessage(key) {
                var _a;
                return __awaiter(this, void 0, void 0, function* () {
                    return ((_a = (yield this.store.loadMessage(key.remoteJid, key.id))) === null || _a === void 0 ? void 0 : _a.message) || undefined;
                });
            } }, config);
        this.store = (0, baileys_1.makeInMemoryStore)({ logger: this.config.logger });
    }
    connect(auth) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.awaitConnectionState("open");
            ...
            return new Promise((res) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if (!this.sock.authState.creds.account) {
                        ...
                        const code = yield this.sock.requestPairingCode(phoneNumber);
                        res(code);
                    }
                    else {
                        res("");
     ...
     */
    awaitConnectionState(connection) {
    ...
    readChats() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.chats[this.id] = new WAModules_1.WAChat(this.id, "pv", this.sock.user.name || this.sock.user.notify || this.sock.user.verifiedName || "");
        });
    }
    /**
    ...
    readUsers() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.users[this.id] = new WAModules_1.WAUser(this.id, this.sock.user.name || this.sock.user.notify || this.sock.user.verifiedName || "");
        });
    }
    /**
    ...
    readChat(chat) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (newChat.id.includes("@g")) {
                ...
                if (!metadata || !(metadata === null || metadata === void 0 ? void 0 : metadata.participants))
                    return newChat;
    ...
    groupParticipantsUpdate(action, chatId, userId, fromId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (event == "add")
                this.chats[chat.id].users[user.id] = user;
            if (event == "promote")
                this.chats[chat.id].users[user.id].isChatAdmin = true;
            if (event == "demote")
                this.chats[chat.id].users[user.id].isChatAdmin = false;
            if (event == "remove")
    ...
    getBotName() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getUserName(UserUtils_1.default.get(this.id));
        });
    }
    setBotName(name) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getBotDescription() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getUserDescription(UserUtils_1.default.get(this.id));
        });
    }
    ...
    getBotProfile() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getUserProfile(UserUtils_1.default.get(this.id));
        });
    }
    setBotProfile(image) {
        return __awaiter(this, void 0, void 0, function* () {
