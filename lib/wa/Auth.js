...
class MultiFileAuthState {
    constructor(folder, autoCreateDir = true) {
        ...
        this.writeData = (data, file) => __awaiter(this, void 0, void 0, function* () {
            return (0, fs_1.writeFileSync)((0, path_1.join)(this.folder, this.fixFileName(file)), data);
        });
        this.readData = (file) => {
            try {
...
function getBaileysAuth(auth) {
    return __awaiter(this, void 0, void 0, function* () {
        let creds = JSON.parse(yield auth.get("creds"), baileys_1.BufferJSON.reviver) || (0, baileys_1.initAuthCreds)();
        return {
            saveCreds: () => __awaiter(this, void 0, void 0, function* () {
                return yield auth.set("creds", JSON.stringify(creds, baileys_1.BufferJSON.replacer));
            }),
            state: {
                creds,
                keys: {
                    get: (type, ids) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield Promise.all(ids.map((id) => __awaiter(this, void 0, void 0, function* () {
                            const path = `${type}-${id}`;
                            let value = JSON.parse(yield auth.get(path), baileys_1.BufferJSON.reviver);
                    ...
                    set: (data) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        for (const category in data) {
                            for (const id in data[category]) {
                                ...
                                tasks.push(auth.set(key, JSON.stringify(value, baileys_1.BufferJSON.replacer)));
                            }
                        }
