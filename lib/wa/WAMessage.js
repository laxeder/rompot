...
class WhatsAppMessage {
    ...
    refactory(message = this._message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, Message_2.isMediaMessage)(message))
                yield this.refactoryMediaMessage(message);
            if ((0, Message_2.isLocationMessage)(message))
                this.refactoryLocationMessage(message);
            if ((0, Message_2.isReactionMessage)(message))
                this.refactoryReactionMessage(message);
            if ((0, Message_2.isContactMessage)(message))
                this.refactoryContactMessage(message);
            if ((0, Message_2.isButtonMessage)(message))
                this.refactoryButtonMessage(message);
            if ((0, Message_2.isListMessage)(message))
                this.refactoryListMessage(message);
            if ((0, Message_2.isPollMessage)(message))
    ...
    refactoryMediaMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, Message_2.isImageMessage)(message)) {
                this.message.image = stream;
            }
            if ((0, Message_2.isVideoMessage)(message)) {
                this.message.video = stream;
            }
            if ((0, Message_2.isAudioMessage)(message)) {
                this.message.audio = stream;
            }
            if ((0, Message_2.isFileMessage)(message)) {
                this.message.file = stream;
            }
            if ((0, Message_2.isStickerMessage)(message)) {
