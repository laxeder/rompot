            ...
            return yield new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    this._bot.ev.on("messages.upsert", (m) => {
                        ...
                        const msg = (0, WAConvertMessage_1.convertMessage)(message, m.type);
    ...
    send(content) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (content instanceof Message_1.Message) {
                ...
                yield waMSG.refactory(content, this);
                const { chat, message, context, relay } = waMSG;
                if (relay == true)
                    return (_a = this._bot) === null || _a === void 0 ? void 0 : _a.relayMessage(chat, message, {});
                return (_b = this._bot) === null || _b === void 0 ? void 0 : _b.sendMessage(chat, message, context);
            }
            //!TODO corrigir status de leitura
            if (content instanceof Status_1.Status) {
                if (content.status === "reading") {
                    return (_c = this._bot) === null || _c === void 0 ? void 0 : _c.readMessages([{ remoteJid: (_d = content.chat) === null || _d === void 0 ? void 0 : _d.id, id: content.id }]);
                }
                const status = this.statusOpts[content.status];
                return (_e = this._bot) === null || _e === void 0 ? void 0 : _e.sendPresenceUpdate(status, (_f = content.chat) === null || _f === void 0 ? void 0 : _f.id);
            }
        });
    }
    /**
