...
class Client extends Emmiter_1.ClientEvents {
    constructor(bot, config = {}) {
        ...
        this.autoMessages = {};
        this.commandController = new command_1.CommandController(this);
        this.reconnectTimes = 0;
        this.bot = bot;
        this.config = Object.assign(Object.assign({}, index_1.DEFAULT_CONNECTION_CONFIG), config);
        this.configEvents();
    }
    get id() {
        return this.bot.id;
        ...
        this.bot.ev.on("message", (message) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (this.promiseMessages.resolvePromiseMessages(message))
                    return;
                message = (0, Generic_1.ApplyClient)(message, this);
                this.emit("message", message);
                if (this.config.disableAutoCommand || message.apiSend)
                    return;
                const command = this.searchCommand(message.text);
                if (command != null) {
                    this.runCommand(command, message, Command_1.CMDRunType.Exec);
                }
            }
            catch (err) {
    ...
    sendMessage(chat, message, mention) {
        return __awaiter(this, void 0, void 0, function* () {
            if ((0, Verify_1.isMessage)(message)) {
                message.chat = Chat_1.default.get(chat);
